...
def win(has_eaten_all_dots, power_pellet_active, touching_ghost):
    ...
    if has_eaten_all_dots is True and lose(power_pellet_active, touching_ghost) is True:
        return False
    if has_eaten_all_dots is True and lose(power_pellet_active, touching_ghost) is False:
        return True
    if has_eaten_all_dots is False and lose(power_pellet_active, touching_ghost) is True:
        return False
    if has_eaten_all_dots is False and lose(power_pellet_active, touching_ghost) is False:
        return False
